...
func use(inventory_slot : int):
	if(vars.scene is BattleRoom):
		...
		settings.player_save.player.current_hp = max(min(settings.player_save.player.current_hp + amount_amount - settings.player_save.player.current_kr, settings.player_save.player.current_hp), settings.player_save.player.max_hp  - settings.player_save.player.current_kr)
